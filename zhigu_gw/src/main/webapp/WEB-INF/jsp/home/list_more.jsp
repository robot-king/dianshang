...
<body>
	...
	<section class="jiage-box">
		<div class="container">
			<!-- <div class="title">
				<h3>模板列表</h3>
			</div> -->
			<!-- 查询条件 -->
			<div class="chaxun-box col-lg-12">
				<div class="chaxun-list" id="condition_grid">
				</div>
				<div class="clear"></div>
			</div>
			<div class="row" id="data_grid">
			</div>
			<!-- 分页按钮 -->
	...
	<script src="js/home/chooseBtnClick.js"></script>
	<script src="js/home/case_list_3.js"></script>     
