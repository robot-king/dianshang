...
public class StringUtil {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String getStrCode(String source, String sourcecode, String code) throws UnsupportedEncodingException {
		String result = "";
		// result = new String(source.getBytes("iso-8859-1"),"GB2312");
		// result =new String(source.getBytes("iso-8859-1"),"UTF-8");
		result = new String(source.getBytes(sourcecode), code);
		return result;
	}
	...
	public static String lowercase(String s) {
		String one = s.substring(0, 1);
		return one.toLowerCase() + s.substring(1, s.length());
	}
	...
	public static int formatDoubleMultiplyOneHundred(double d) {
		double number = Double.valueOf(formatDouble(d));
		return (int) (number * 100);
	}

	// 统计字符串中汉字字数
	public static int staticsChineseCount(String text) {
		String Reg = "^[\u4e00-\u9fa5]{1}$";// 正则
		int result = 0;
	...
	public static String getStringEncode(String str) {
		...
		String code = BytesEncodingDetect.javaname[s.detectEncoding(str.getBytes())];
		return code;
	}
