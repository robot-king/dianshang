...
public class DateUtil {
	 ...
	 * yyyyMMddHHmmss
	 */
	public static final String DATE_LONG_PATTERN_PLAIN = "yyyyMMddHHmmss";
	...
	public static java.text.SimpleDateFormat sdfLongTimePlus1 = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm");
	 ...
	 * @return date加上intBetween年数后的日期
	 */
	public static Date increaseMinutes(Date date, int intBetween) {
		Calendar calo = Calendar.getInstance();
		calo.setTime(date);
	 ...
	 * @return date加上intBetween年数后的日期
	 */
	public static Date increaseSeconds(Date date, int intBetween) {
		Calendar calo = Calendar.getInstance();
		calo.setTime(date);
	...
	public static Date getDateByType(Date date, String format) {
		return DateUtil.parseDate(DateUtil.longDate(date), format);
	}
	...
	public static String dateDifferent(String date1, String date2) {
		...
		try {
			...
			System.out.print(diff + " 毫秒.");
			path = diffDays + " 天, " + diffHours + " 小时, " + diffMinutes + " 分钟, " + diffSeconds + " 秒," + diff + "毫秒";
		} catch (Exception e) {
			e.printStackTrace();
		}
		return path;
	...
	public static int dateDifferent(Date date1, Date date2) {
		...
		try {
			...
			hours = Integer.parseInt(String.valueOf(diffDays)) * 24 + Integer.parseInt(String.valueOf(diffHours));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return hours;
	 ...
	 * 
	 */
	public static String longTimefromToday(Date date) {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date);
	...
	// 输出spring task cron 表达式
	public static String taskCron(Date date) {
		String dataStr = DateUtil.DateToStr(date, "yyyy MM dd HH mm ss");
		...
		// 去除中括号，去除英文逗号和空格", "
		return org.apache.commons.lang3.StringUtils.strip(list.toString(), "[]").replaceAll(", ", " ");
	}

	public static void main(String[] args) {
		Date date1 = new Date();
		// System.out.println(DateUtil.DateToStr(date1, LONG_DATE_PATTERN));
		// System.out.println(DateUtil.DateToStr(date2, LONG_DATE_PATTERN));
		// dateDifferent(DateUtil.DateToStr(date1, LONG_DATE_PATTERN),
		// DateUtil.DateToStr(date2, LONG_DATE_PATTERN));
		String dataStr = "2017-09-28 12:26:00";
		
		String dataStr2 = taskCron(parseDate(dataStr, LONG_DATE_PATTERN));
