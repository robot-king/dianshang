...
public class HttpClientCustomSSL {
	...
	public static String httpClientResultGetPublicKey(String xml) throws Exception {
		...
		StringEntity myEntity = new org.apache.http.entity.StringEntity(xml, PayConfigUtil.CHARSET);
		myEntity.setContentType("text/xml;charset=UTF-8");
		myEntity.setContentEncoding(PayConfigUtil.CHARSET);
		...
		try {
			...
			if (entity != null) {
				...
				inputStreamReader = new InputStreamReader(inputStream, PayConfigUtil.CHARSET);
	...
	/**
	 * httpClient 请求企业支付到微信零钱
	 * 
	 * @param parms
	 * @return
	 * @throws Exception
	 */
	public static String httpClientResultWeiXinLingQian(String xml) throws Exception {
		StringBuffer reultBuffer = new StringBuffer();
